...
function determineActions($urls, $preferred_prefix = false)
{
	...
	$allowedActions = array(
		'admin' => array('moderate_forum', 'manage_membergroups', 'manage_bans', 'admin_forum', 'manage_permissions', 'send_mail', 'manage_attachments', 'manage_smileys', 'manage_boards', 'edit_news', 'pmx_settings', 'pmx_blocks', 'pmx_articles', 'pmx_categories'),
...
function Credits($in_admin = false)
{
	...
	$context['credits_software_graphics'] = array(
		...
		'software' => array(
			...
			'<a href="http://ckeditor.com">CKEditor</a> | &copy; Frederico Knabben | CKEditor is distributed under the GPL, LGPL and MPL Open Source licenses',
			'<br>',
		),
		'fonts' => array(
