...
function profileSendActivation()
{
	...
	$_SESSION['log_time'] = 0;
	$_SESSION['login_' . $cookiename] = json_encode(array(0, '', 0), true);
...
function groupMembership2($profile_vars, $post_errors, $memID)
{
	...
	if ($changeType == 'request')
	{
		...
		$data = json_encode(array('id_member' => $memID, 'member_name' => $user_info['name'], 'id_group' => $group_id, 'group_name' => $group_name, 'reason' => $_POST['reason'], 'time' => time()), true);
