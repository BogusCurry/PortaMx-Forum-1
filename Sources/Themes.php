...
function InstallCopy()
{
	...
	$to_copy = array('/index.php', '/index.template.php', '/css/index.css', '/css/mobile.css', '/css/slider.min.css', '/css/rtl.css', '/css/calendar.css', '/css/calendar.rtl.css', '/css/admin.css', '/scripts/theme.js');
...
function SetJavaScript()
{
	...
	if ($_GET['var'] == 'admin_preferences')
	{
		...
		$_GET['val'] = json_encode($options['admin_preferences'], true);
	}
