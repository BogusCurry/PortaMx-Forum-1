...
{
	global $context, $settings, $txt, $scripturl, $user_info, $modSettings;
	...
	*/
	...
	{
		if($menu_context['current_action'] == 'admin' && !empty($modSettings['portal_enabled']))
			Portal_AdminMenu($menuData);
