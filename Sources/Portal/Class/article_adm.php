	...
	*/
	function pmxc_AdmBlock_settings()
	{
		...
		echo '
							...
							<div>
								<div style="float:left;">'. $txt['pmx_artblock_arts'] .'</div>
								<div style="float:right;width:55%;padding-right:10%;">
									<select style="width:87.5%;" name="config[settings][article]" size="1">';
