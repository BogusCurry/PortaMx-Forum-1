	...
	$listOptions = array(
		...
		'additional_rows' => array(
			array(
				...
				'value' => '<input type="hidden" name="' . $context['session_var'] . '" value="' . $context['session_id'] . '"><input type="submit" name="set_default" value="' . $txt['save'] . '"' . (is_writable($boarddir . '/Settings.php') ? '' : ' disabled') . ' class="button_submit"><div style="height:28px"></div>',
			),
			array(
