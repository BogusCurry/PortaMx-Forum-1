...
function template_main()
{
	...
	// Link to portamx.com for latest themes and info!
	echo '
		<br>
		<div class="cat_bar">
			<h3 class="catbg">
...
function template_edit_style()
{
	...
	echo '
				...
				<div class="padding righttext">
					...
					<input type="button" value="', $txt['themeadmin_edit_preview'], '" onclick="refreshPreview(false);" class="button_submit" style="margin-top:6px;">
				</div>
			</div>
