<?php
// Version: 1.0 RC3; ManageMaintenance
...
$txt['maintain_cache_info'] = 'This function will empty out the cache should you need it to be cleared.
	If you have enabled "Display the Cache status for every page" you can (as Administrator) clear the cache simple by click on the word <b>Cache:</b> in the Footer.';
