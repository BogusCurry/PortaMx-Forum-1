...
$txt['theme_adding'] = 'You can always find new themes for your forum from the PortaMx Forum themes area. You can browse them on the website, read the comments, and download them to your computer and then upload them to your forum from there.<br><br>If you run into any questions with themes, each modification published on portamx.com has a dedicated topic about it where support and comments should be directed to.';
