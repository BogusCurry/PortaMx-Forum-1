...
$.sceditor.command.set(
	'link', {
		txtExec: function (caller, selected) {
			var	display = selected && (selected.indexOf('http://') > -1 || selected.indexOf('https://') > -1) ? null : selected,
...
$.sceditor.plugins.bbcode.bbcode.set(
	'img', {
		...
		html: function (token, attrs, content) {
			...
			return '<img' + attribs + ' src="' + content + '" style="vertical-align:top">';
		}
	}
);
	...
	'attach', {
		...
		html: function (token, attrs, content) {
			...
			if ((typeof attrs.type !== "undefined" && !attrs.type.match(/image.*/)) || contentIMG.getAttribute('width') == 0){
				...
				return '<img' + attribs + ' src="' + contentUrl +'" data-attachment="' + content + '" style="vertical-align:top">';
			}
		}
	}
);
