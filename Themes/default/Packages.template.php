			...
			<div id="advanced_box" >
				...
				<div id="advanced_panel_div" class="windowbg2">
					...
					<dl class="settings">
						...
						{
							echo '
								<option value="', $version, '"', ($version == str_replace('PortaMx Forum ', '', $context['selected_version']) ? ' selected="selected"' : ''), '>', $version, '</option>';
						}
...
function template_file_permissions()
{
	...
	<form action="', $scripturl, '?action=admin;area=packages;sa=perms;', $context['session_var'], '=', $context['session_id'], '" method="post" accept-charset="', $context['character_set'], '">
		...
		<table class="table_grid" style="table-layout:fixed">
			<thead>
				<tr class="title_bar_adm">
					<th class="lefttext" width="38.5%">&nbsp;', $txt['package_file_perms_name'], '&nbsp;</th>
					<th width="150px" class="lefttext">', $txt['package_file_perms_status'], '</th>
					...
					<th width="8%" style="line-height:12px"><span class="filepermissions">', $txt['package_file_perms_status_no_change'], '</span></th>
				</tr>
			</thead>
			<tbody>';
