...
function template_control_richedit_buttons($editor_id)
{
	...
	elseif ($context['show_spellchecking'])
		$tempTab++;
	elseif (isset($editor_context['cancel_link']) && $editor_context['id'] != 'quickReply')
		$tempTab++;
		...
		if ($i == 0 && $verify_context['show_visual'])
		{
			...
			echo '
				<div class="smalltext" style="margin: 4px 0 8px 0;">
					<a href="', $verify_context['image_href'], ';sound" id="visual_verification_', $verify_id, '_sound" rel="nofollow">', $txt['visual_verification_sound'], '</a> / <span class="visual_verification_href" id="visual_verification_', $verify_id, '_refresh">', $txt['visual_verification_request_new'], '</span>', $display_type != 'quick_reply' ? '<br>' : '', '<br>
