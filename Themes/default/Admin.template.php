...
function template_admin()
{
	...
	// Display the "live news" from portamx.com
	echo '
	...
	// The below functions include all the scripts needed from the portamx.com site. The language and format are passed for internationalization.
...
function template_view_versions()
{
	...
	/* Below is the hefty javascript for this. Upon opening the page it checks the current file versions with ones
	   held at portamx.com and works out if they are up to date.  If they aren't it colors that files number
