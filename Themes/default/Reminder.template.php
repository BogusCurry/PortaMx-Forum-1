...
function template_main()
{
	...
	echo '
	<form action="', $scripturl, '?action=reminder;sa=picktype" method="post" accept-charset="', $context['character_set'], '" style="margin-top:20px">
		<div class="tborder login">
			<div class="cat_bar">
				<h3 class="catbg" style="text-align:center">', $txt['authentication_reminder'], '</h3>
			</div>
