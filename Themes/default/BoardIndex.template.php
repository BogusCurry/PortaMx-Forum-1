...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		$category['link'] = str_replace('<a id="c'. $category['id'] .'"></a>', '', $category['link']);
		echo '
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				<div id="board_', $board['id'], '" class="up_contain ', (!empty($board['css_class']) ? $board['css_class'] : '') ,'">
					...
					<div class="info">
						<a class="subject" href="', $board['href'], '#ptop" id="b', $board['id'], '">', $board['name'], '</a>';
...
function template_info_center()
{
	...
	<div class="roundframe" id="info_center">
		...
		<div id="upshrinkHeaderIC" style="display:'. ($context['user']['is_guest'] ? (empty(get_cookie('upshrinkIC')) ? 'block' : 'none') : (empty($options['collapse_header_ic']) ? 'block' : 'none')) .'">';
