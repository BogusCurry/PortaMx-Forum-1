...
$GLOBALS['current_pmx_version'] = 'PortaMx-Forum 1.0 RC3';
...
<html>
	...
	<body style="font-family: sans-serif;"><div style="width: 600px;">
		...
		<p>If you continue to get this error message, feel free to <a href="https://www.portamx.com/">look to us for support</a>.</p>
	</div></body>
</html>';
		die;
	}
...
function DatabasePopulation()
{
	...
	$replaces = array(
		'{$db_prefix}' => $db_prefix,
		'{$attachdir}' => json_encode(array(1 => $pmxcFunc['db_escape_string']($attachdir)), true),
...
class ftp_connection
{
	...
	function ftp_connection($ftp_server, $ftp_port = 21, $ftp_user = 'anonymous', $ftp_pass = 'ftpclient@portamx.com')
	{
		if ($ftp_server !== null)
			$this->connect($ftp_server, $ftp_port, $ftp_user, $ftp_pass);
	}

	function connect($ftp_server, $ftp_port = 21, $ftp_user = 'anonymous', $ftp_pass = 'ftpclient@portamx.com')
	{
