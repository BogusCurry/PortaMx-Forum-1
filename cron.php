...
global $pmxcFunc, $pmxCache, $ssi_db_user, $scripturl, $db_passwd, $cachedir;
...
function perform_task($task_details)
{
	...
	{
		$details = empty($task_details['task_data']) ? array() : pmx_json_decode($task_details['task_data'], true);
