...
?>
			...
			<p><strong>Current Version:</strong> 1.0 RC3</p>
...
<html>
	<head>
		<title>PortaMx Forum 1.0 RC3 SSI.php Examples</title>
	...
	<body>
		<div id="header">
			<h1 class="forumtitle">PortaMx Forum 1.0 RC3 SSI.php Examples</h1>
...
function template_ssi_below()
{
	echo '
			...
			<div id="footer">
				<a href="#header" id="pbot" class="go_up"></a>
				<ul>
					<li class="copyright">
